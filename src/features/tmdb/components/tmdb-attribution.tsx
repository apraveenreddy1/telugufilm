    ...
    <Box sx={{ padding: 2, textAlign: 'center' }}>
      <NextLink href="https://www.telugufilm.info/" aria-label="The Movie DB">
       ...
       {/* <ImageComponent /> */}
        ...
        <image href="./logo.jpeg"  width="100" height="100" preserveAspectRatio="xMidYMid meet" />
          {/* <defs>
            <linearGradient
      ...
      {/* <Typography fontSize={'caption.fontSize'}>
...
const ImageComponent = () => {
  ...
  return <Image src='/logo.jpeg' width={100} height={100} alt='logo' />;
};
